...
#define INFRA_NB      3 // Number of infrared sensors.
...
//each sensor localisation si done from the kinect Point of view
  NewPing(6, 7, MAX_DISTANCE), //LEFT Sensor
  NewPing(12, 13, MAX_DISTANCE), //FRONT LEFT Sensor
  NewPing(10, 11, MAX_DISTANCE), //FRONT RIGHT Sensor
  NewPing(8, 9, MAX_DISTANCE) //RIGH Sensor
