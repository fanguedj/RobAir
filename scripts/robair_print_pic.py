...
#
# Modifie par l'equipe Fablab Ensimag : Projet de Specialite
...
class ViewerGtk:
    ...
    def __init__(self,picture):
        ...
        self.window.set_title('Pictures Viewer')
    ...
    def display(self):
    	self.image.set_from_file(self.picture)

if __name__ == "__main__":
    gui = ViewerGtk(sys.argv[1])
    gtk.main()
